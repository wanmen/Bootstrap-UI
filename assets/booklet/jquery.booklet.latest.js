...
;(function ($) {
    ...
    $.fn.booklet.defaults = {
        ...
        width:                $(window).width()*0.85,                             // container width
        height:               $(window).height()*0.95,                             // container height
        ...
        hoverWidth:           40,                              // default width for page-turn hover preview
        ...
        tabWidth:             200,                              // set the width of the tabs
        tabHeight:            20,                              // set the height of the tabs
        nextControlText:      '下一页',                          // inline text for all 'next' controls
        previousControlText:  '上一页',                      // inline text for all 'previous' controls
        nextControlTitle:     '下一页',                     // text for title attributes of all 'next' controls
        previousControlTitle: '上一页',                 // text for title attributes of all 'previous' controls
